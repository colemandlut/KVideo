...
var F = /* @__PURE__ */ __name((e, t, n) => (n = e != null ? ne(ie(e)) : {}, ce(t || !e || !e.__esModule ? U(n, "default", { value: e, enumerable: true }) : n, e)), "F");
var m;
var p = E(() => {
  m = { collectedLocales: [] };
});
  ...
  function Te(e, t) {
    ...
    for (var n = {}, s = t || {}, a = s.decode || je, i = 0; i < e.length; ) {
      ...
      if (n[c] === void 0) {
        ...
        h.charCodeAt(0) === 34 && (h = h.slice(1, -1)), n[c] = ke(h, a);
      }
      i = o + 1;
    }
    return n;
...
__name(O, "O");
async function P(e, { request: t, assetsFetcher: n, ctx: s }, { path: a, searchParams: i }) {
...
var C = class {
  ...
  async runRouteMiddleware(t) {
    ...
    let s = await P(n, this.reqCtx, { path: this.path, searchParams: this.searchParams, headers: this.headers, status: this.status });
...
async function Se(e, { path: t = "/404", status: n, headers: s, searchParams: a, body: i }, r) {
  ...
  } else c = await P(r[t], e, { path: t, status: n, headers: s, searchParams: a });
  let h = s.normal;
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.0009757761448511149.mjs.map
