...
// .wrangler/tmp/pages-HpFROo/bundledWorker-0.8227124323385256.mjs
...
var q = V((ze, F) => {
  ...
  function v(e, t) {
    ...
    }), e = e.replace(/\[:([^:]+):\]/g, (o, c) => v.characterClasses[c] || o), new v.PCRE(e, a, n, a, s);
  }
  __name(v, "v");
  __name2(v, "v");
  function le(e, t) {
...
function de(e, t) {
  ...
  let d = e.headers.get("Accept") ?? "", x = t?.formats?.find((b) => d.includes(b))?.replace("image/", "");
...
function ge() {
  ...
  globalThis.fetch = async (...t) => {
    let n = new Request(...t), s = await ve(n);
...
var C = class {
  ...
  applyRouteDest(t, n, s) {
    ...
    return g(this.searchParams, b.searchParams), R(this.path) || (this.path = b.pathname), a;
  }
...
// ../../../.nvm/versions/node/v24.11.1/lib/node_modules/wrangler/templates/pages-dev-util.ts
...
// .wrangler/tmp/pages-HpFROo/xtrecd2v3ba.js
...
// .wrangler/tmp/bundle-sgjRLe/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-sgjRLe/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=xtrecd2v3ba.js.map
